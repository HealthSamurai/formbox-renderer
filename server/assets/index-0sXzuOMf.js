        ...
        /* @__PURE__ */ jsxs("section", { className: "relative overflow-hidden pb-24 pt-32", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "container grid gap-12 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:px-8", children: [
            /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
              /* @__PURE__ */ jsx("span", { className: "inline-flex items-center gap-2 rounded-full border border-border/60 bg-muted/60 px-4 py-1 text-[0.72rem] uppercase tracking-[0.2em] text-muted-foreground animate-fade-up motion-reduce:animate-none [animation-delay:0ms]", children: "Open-source · FHIR R4 + R5 · React" }),
              /* @__PURE__ */ jsx(
                SplitText,
                {
                  text: heroHeadline,
              ...
              /* @__PURE__ */ jsx("p", { className: "text-lg text-muted-foreground animate-fade-up motion-reduce:animate-none [animation-delay:240ms]", children: "Formbox Renderer is a typed React renderer for FHIR R4 and R5 Questionnaires. Build clinical forms once, then ship them with pluggable themes, predictable state, and Storybook-ready previews." }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-3 text-sm animate-fade-up motion-reduce:animate-none [animation-delay:480ms]", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "rounded-full border border-border/60 bg-muted/60 px-3 py-1 text-muted-foreground", children: "FHIR R4 + R5 ready" }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "rounded-3xl border border-border/70 bg-card/80 p-7 shadow-xl shadow-black/40 backdrop-blur animate-fade-up motion-reduce:animate-none [animation-delay:200ms]", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                ...
                /* @__PURE__ */ jsx("span", { className: "rounded-full border border-border/60 bg-muted/60 px-2 py-1 text-[0.65rem] font-semibold text-foreground", children: "FHIR R4 + R5" })
              ] }),
          ...
          "section",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "container", children: [
              /* @__PURE__ */ jsxs("div", { className: "max-w-2xl", children: [
                ...
                /* @__PURE__ */ jsx("p", { className: "mt-3 text-base text-muted-foreground", children: "Purpose-built for FHIR R4 and R5 Questionnaires with a fully typed renderer, tested helpers, and predictable state management." })
              ] }),
                ...
                /* @__PURE__ */ jsxs("article", { className: "rounded-2xl border border-border/60 bg-card/70 p-6 shadow-lg shadow-black/30 transition hover:border-ring/60 md:col-span-6 lg:col-span-7", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "mt-4 space-y-2 text-sm text-muted-foreground", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                      ...
                      /* @__PURE__ */ jsx("span", { children: "FHIR R4 + R5 Questionnaire ready" })
                    ] }),
                    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-primary" }),
                    ...
                    /* @__PURE__ */ jsxs(
                      "svg",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsx("path", { d: "M9 5c0 9 6 14 6 14" }),
                          /* @__PURE__ */ jsx("path", { d: "M15 5c0 9-6 14-6 14" })
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsx("h3", { className: "font-display text-lg text-foreground", children: "Multilingual forms ready" })
                  ] }),
                  /* @__PURE__ */ jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "Render multilingual questionnaires with interface text ready in multiple languages, and let users switch language while filling the same form." })
                ] }),
                /* @__PURE__ */ jsxs("article", { className: "rounded-2xl border border-border/60 bg-card/70 p-6 shadow-lg shadow-black/30 transition hover:border-ring/60 md:col-span-6 lg:col-span-6", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsxs(
