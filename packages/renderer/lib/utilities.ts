...
export const EXT = {
  ...
  SDC_UNIT_SUPPLEMENTAL_SYSTEM:     "http://hl7.org/fhir/uv/sdc/StructureDefinition/sdc-questionnaire-unitSupplementalSystem",
  ...
  SDC_VARIABLE:                     "http://hl7.org/fhir/StructureDefinition/variable",
