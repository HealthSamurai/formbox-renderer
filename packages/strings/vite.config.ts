  ...
  build: {
    lib: {
      entry: {
        ...
        fi: path.resolve(__dirname, "lib/fi.ts"),
        fr: path.resolve(__dirname, "lib/fr.ts"),
        it: path.resolve(__dirname, "lib/it.ts"),
        nl: path.resolve(__dirname, "lib/nl.ts"),
        pl: path.resolve(__dirname, "lib/pl.ts"),
        pt: path.resolve(__dirname, "lib/pt.ts"),
        ru: path.resolve(__dirname, "lib/ru.ts"),
        sv: path.resolve(__dirname, "lib/sv.ts"),
        tr: path.resolve(__dirname, "lib/tr.ts"),
      },
