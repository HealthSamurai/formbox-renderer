...
`,ln=b.span`
  ...
  color: var(--nhsuk-secondary-text-colour);
`;Q.__docgenInfo={description:"",methods:[],displayName:"LoadingSpinner",props:{label:{required:!1,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:"",defaultValue:{value:'"Loading options..."',computed:!1}},showLabel:{required:!1,tsType:{name:"union",raw:"boolean | undefined",elements:[{name:"boolean"},{name:"undefined"}]},description:"",defaultValue:{value:"false",computed:!1}},size:{required:!1,tsType:{name:"union",raw:'"sm" | "md" | undefined',elements:[{name:"literal",value:'"sm"'},{name:"literal",value:'"md"'},{name:"undefined"}]},description:"",defaultValue:{value:'"sm"',computed:!1}}}};function ye({options:n,selectedOption:t,onChange:s,onSearch:r,specifyOtherOption:a,customOptionForm:o,id:u,ariaLabelledBy:i,ariaDescribedBy:d,disabled:c=!1,isLoading:p=!1,placeholder:x}){const g=y.useRef(null),m=y.useRef(null),[w,v]=y.useState(""),[j,k]=y.useState(!1),[_,R]=y.useState(!1),[C,f]=y.useState(),N=y.useRef(new Map),T=!!o,M=j||T,B=!!r&&M,F=t?.token??"",L=!t,I=l=>{v(l),r?.(l)},X=t?t.label:e.jsx(dn,{children:x??"Select an option"}),D=`${u}-listbox`,E=y.useMemo(()=>a?[...n,a]:n,[n,a]),G=a?n.length:-1,H=y.useMemo(()=>{if(!M||E.length===0)return;const l=C?E.find(Y=>Y.token===C):void 0;if(l&&!l.disabled)return l.token;const S=F?E.find(Y=>Y.token===F):void 0;return S&&!S.disabled?S.token:E.find(Y=>!Y.disabled)?.token},[C,M,F,E]),q=E.findIndex(l=>l.token===H),A=q===-1?void 0:`${D}-option-${q}`;y.useEffect(()=>{if(!M||H===void 0)return;N.current.get(H)?.scrollIntoView?.({block:"nearest"})},[M,H]),y.useEffect(()=>{j&&m.current?.focus()},[j]);const Z=l=>{c||p||(s(l),I(""),R(!1),f(void 0),k(!1))},O=()=>{s(),I(""),R(!1),f(void 0),k(!1)},ee=(l,S)=>{if(E.length===0)return-1;const z=E.length,Y=l<0?S===1?-1:z:l;for(const J of E.keys()){const ae=((Y+S*(J+1))%z+z)%z;if(!E[ae].disabled)return ae}return-1},U=l=>{const S=[...E.keys()];l===-1&&S.reverse();for(const z of S)if(!E[z].disabled)return z;return-1},h=l=>{if(T||g.current==null)return;const S=l.relatedTarget;if(S&&g.current.contains(S))return;!c&&!p&&_&&w.trim().length===0&&t&&s(),f(void 0),k(!1)},$=l=>{if(l.key==="ArrowDown"||l.key==="ArrowUp"){if(l.preventDefault(),!M){I(""),R(!1),k(!0);return}const S=l.key==="ArrowDown"?1:-1,z=ee(q,S);z!==-1&&f(E[z].token);return}if(l.key==="Home"||l.key==="End"){l.preventDefault(),M||(I(""),R(!1),k(!0));const S=l.key==="Home"?1:-1,z=U(S);z!==-1&&f(E[z].token);return}if(l.key==="Enter"){if(l.preventDefault(),!M){I(""),R(!1),k(!0);return}if(q!==-1){const S=E[q];S.disabled||Z(S.token)}return}if(l.key==="Escape"){if(T)return;f(void 0),k(!1)}};return e.jsxs(un,{"aria-busy":p||void 0,ref:g,onBlur:h,"data-has-spinner":p?"true":void 0,"data-disabled":c||p?"true":void 0,children:[B?e.jsx(cn,{ref:m,id:u,className:"nhsuk-input",value:w,onChange:l=>{I(l.target.value),R(!0),k(!0)},onFocus:()=>{!c&&!p&&(I(""),R(!1),k(!0))},onClick:()=>{!c&&!p&&!j&&(I(""),R(!1),k(!0))},onKeyDown:$,disabled:c||p,"aria-labelledby":i,"aria-describedby":d,role:"combobox","aria-autocomplete":"list","aria-expanded":M,"aria-controls":D,"aria-activedescendant":M&&A?A:void 0,placeholder:x??"Select an option",autoComplete:"off"}):e.jsx(hn,{id:u,className:"nhsuk-input",role:"combobox","aria-labelledby":i,"aria-describedby":d,"aria-expanded":M,"aria-controls":D,"aria-placeholder":t?void 0:x??"Select an option","aria-disabled":c||p?!0:void 0,tabIndex:c||p?-1:0,"data-disabled":c||p?"true":void 0,onClick:()=>{!c&&!p&&!j&&(I(""),R(!1),k(!0))},onKeyDown:$,children:X}),e.jsxs(mn,{children:[p&&e.jsx(kn,{"aria-hidden":"true",children:e.jsx(Q,{})}),t?e.jsx(pn,{type:"button",onClick:O,disabled:c||p,"data-disabled":c||p?"true":void 0,onMouseDown:l=>l.preventDefault(),"aria-label":"Clear"}):L&&e.jsx(vn,{"aria-hidden":"true"})]}),M&&e.jsx(fn,{id:D,role:"listbox","aria-labelledby":i,"aria-describedby":d,children:o?e.jsx(bn,{role:"presentation",children:o}):e.jsxs(e.Fragment,{children:[n.map((l,S)=>e.jsx(de,{id:`${D}-option-${S}`,type:"button",role:"option","aria-selected":l.token===F,"aria-disabled":l.disabled||void 0,disabled:l.disabled,"data-active":l.token===H,ref:z=>{z?N.current.set(l.token,z):N.current.delete(l.token)},onFocus:()=>f(l.token),onKeyDown:$,onClick:()=>{l.disabled||Z(l.token)},children:l.label},l.token)),a&&e.jsx(de,{id:`${D}-option-${G}`,type:"button",role:"option","aria-selected":a.token===F,"aria-disabled":a.disabled||void 0,disabled:!!a.disabled,"data-active":a.token===H,"data-sticky":"true",ref:l=>{l?N.current.set(a.token,l):N.current.delete(a.token)},onFocus:()=>f(a.token),onKeyDown:$,onClick:()=>{a.disabled||Z(a.token)},children:a.label})]})})]})}const un=b.div`
  position: relative;
  flex: 1;
  min-width: 100px;
  width: 100%;
...
`;we.__docgenInfo={description:"",methods:[],displayName:"CheckboxList"};function _n(n,t){if(!(n instanceof Element))return!1;const s=n.closest("input,textarea,select,button,a,[contenteditable]");return!!s&&s!==t}function Ie({options:n,onSelect:t,onDeselect:s,onSearch:r,id:a,specifyOtherOption:o,ariaLabelledBy:u,ariaDescribedBy:i,disabled:d=!1,isLoading:c=!1,selectedOptions:p,customOptionForm:x,placeholder:g}){const m=y.useRef(null),[w,v]=y.useState(""),j=y.useRef(null),[k,_]=y.useState(!1),[R,C]=y.useState(),f=y.useRef(new Map),N=!!x,T=k||N,M=!!r,V=y.useMemo(()=>new Set(p.map(h=>h.token)),[p]),B=`${a}-listbox`,F=h=>{v(h),r?.(h)},L=y.useMemo(()=>n.filter(h=>!V.has(h.token)),[n,V]),I=y.useMemo(()=>o?[...L,o]:L,[L,o]),X=o?L.length:-1,D=y.useMemo(()=>{if(!T||I.length===0)return;const h=R?I.find(l=>l.token===R):void 0;return h&&!h.disabled?h.token:I.find(l=>!l.disabled)?.token},[R,T,I]),E=I.findIndex(h=>h.token===D),G=E===-1?void 0:`${B}-option-${E}`;y.useEffect(()=>{if(!T||D===void 0)return;f.current.get(D)?.scrollIntoView?.({block:"nearest"})},[D,T]);const H=h=>{h.length===0||d||c||(t(h),F(""),C(void 0),_(!1))},q=()=>{j.current?.focus()},A=()=>{d||c||_(!0)},Z=(h,$)=>{if(I.length===0)return-1;const l=I.length,S=h<0?$===1?-1:l:h;for(const z of I.keys()){const J=((S+$*(z+1))%l+l)%l;if(!I[J].disabled)return J}return-1},O=h=>{const $=[...I.keys()];h===-1&&$.reverse();for(const l of $)if(!I[l].disabled)return l;return-1},ee=h=>{if(N||!m.current)return;const $=h.relatedTarget;$&&m.current.contains($)||(F(""),C(void 0),_(!1))},U=h=>{if(h.key==="ArrowDown"||h.key==="ArrowUp"){if(h.preventDefault(),!T){A();return}const $=h.key==="ArrowDown"?1:-1,l=Z(E,$);l!==-1&&C(I[l].token);return}if(h.key==="Home"||h.key==="End"){h.preventDefault(),T||A();const $=h.key==="Home"?1:-1,l=O($);l!==-1&&C(I[l].token);return}if(h.key==="Enter"){if(h.preventDefault(),!T){A();return}if(E!==-1){const $=I[E];$.disabled||H($.token)}return}if(h.key==="Escape"){if(N)return;F(""),C(void 0),_(!1)}};return e.jsxs(Nn,{className:"nhsuk-input",ref:m,onBlur:ee,onMouseDown:h=>{h.target===h.currentTarget&&(h.preventDefault(),q(),A())},"data-disabled":d?"true":void 0,"aria-busy":c||void 0,children:[p.map(h=>{const $=d||c||!!h.disabled;return e.jsxs(wn,{children:[e.jsxs(In,{type:"button",className:"nhsuk-tag",disabled:$,onClick:l=>{$||_n(l.target,l.currentTarget)||s(h.token)},children:[e.jsx("span",{className:"nhsuk-u-visually-hidden",children:"Remove "}),h.label,e.jsx(Cn,{"aria-hidden":"true"})]}),h.errors]},h.token)}),e.jsx($n,{children:M?e.jsx(Rn,{ref:j,id:a,value:w,onChange:h=>{F(h.target.value),A()},onFocus:()=>{A()},onClick:()=>{A()},onKeyDown:U,disabled:d||c,"aria-labelledby":u,"aria-describedby":i,role:"combobox","aria-autocomplete":"list","aria-expanded":T,"aria-controls":B,"aria-activedescendant":T&&G?G:void 0,placeholder:g??"Select an option",autoComplete:"off"}):e.jsx(Tn,{id:a,role:"combobox","aria-labelledby":u,"aria-describedby":i,"aria-busy":c||void 0,"aria-expanded":T,"aria-controls":B,"aria-activedescendant":T&&G?G:void 0,"aria-disabled":d||c?!0:void 0,tabIndex:d||c?-1:0,onFocus:A,onMouseDown:h=>{h.preventDefault(),q(),A()},onKeyDown:U,children:p.length===0&&e.jsx(En,{children:g??"Select an option"})})}),c&&e.jsx(Sn,{children:e.jsx(Q,{})}),e.jsx(Dn,{"aria-hidden":"true"}),T&&e.jsx(Mn,{id:B,role:"listbox","aria-labelledby":u,"aria-describedby":i,children:x?e.jsx(Fn,{role:"presentation",children:x}):e.jsxs(e.Fragment,{children:[L.map((h,$)=>e.jsx(Ce,{id:`${B}-option-${$}`,type:"button",role:"option","aria-selected":V.has(h.token),"aria-disabled":h.disabled||void 0,disabled:!!h.disabled,"data-active":h.token===D,ref:l=>{l?f.current.set(h.token,l):f.current.delete(h.token)},onFocus:()=>C(h.token),onKeyDown:U,onClick:()=>{h.disabled||H(h.token)},children:h.label},h.token)),o&&e.jsx(zn,{id:`${B}-option-${X}`,type:"button",role:"option","aria-selected":V.has(o.token),"aria-disabled":o.disabled||void 0,disabled:!!o.disabled,"data-active":o.token===D,ref:h=>{h?f.current.set(o.token,h):f.current.delete(o.token)},onFocus:()=>C(o.token),onKeyDown:U,onClick:()=>{o.disabled||H(o.token)},children:o.label},o.token)]})})]})}const Nn=b.div`
  height: auto;
  display: flex;
  flex-wrap: wrap;
  gap: calc(var(--nhsuk-spacing-1) + var(--nhsuk-border-width-form-element));
...
`;Ie.__docgenInfo={description:"",methods:[],displayName:"MultiSelectInput",props:{disabled:{defaultValue:{value:"false",computed:!1},required:!1},isLoading:{defaultValue:{value:"false",computed:!1},required:!1}}};function $e({content:n,errors:t,submit:s,cancel:r}){return e.jsxs(An,{children:[n,t,e.jsxs("div",{className:"nhsuk-button-group nhsuk-button-group--small nhsuk-u-margin-right-0",children:[e.jsx("button",{type:"button",onClick:r.onClick,disabled:r.disabled,className:"nhsuk-button nhsuk-button--small nhsuk-button--secondary",children:r.label}),e.jsx("button",{type:"button",onClick:s.onClick,disabled:s.disabled,className:"nhsuk-button nhsuk-button--small nhsuk-button--secondary",children:s.label})]})]})}const An=b.div`
  display: flex;
  flex-direction: column;
  gap: var(--nhsuk-spacing-3);
`;$e.__docgenInfo={description:"",methods:[],displayName:"CustomOptionForm"};function Re({id:n,messages:t}){if(t.length!==0)return e.jsx("div",{id:n,children:t.map((s,r)=>e.jsxs("span",{className:"nhsuk-error-message",children:[e.jsx("span",{className:"nhsuk-u-visually-hidden",children:"Error:"})," ",s]},r))})}Re.__docgenInfo={description:"",methods:[],displayName:"Errors"};function Pn(n){return typeof globalThis.matchMedia!="function"?!1:globalThis.matchMedia(n).matches}function Vn(n){const[t,s]=y.useState(()=>Pn(n));return y.useEffect(()=>{if(typeof globalThis.matchMedia!="function")return;const r=globalThis.matchMedia(n),a=()=>{s(r.matches)};return a(),typeof r.addEventListener=="function"?(r.addEventListener("change",a),()=>{r.removeEventListener("change",a)}):(r.addListener(a),()=>{r.removeListener(a)})},[n]),t}function Te({prefix:n,shortText:t,children:s,id:r,htmlFor:a,required:o,help:u,legal:i,flyover:d,as:c="label"}){const x=Vn("(max-width: 40rem)")?t:s,g=e.jsxs(e.Fragment,{children:[n&&e.jsx(Bn,{children:n}),x,o&&e.jsx("span",{"aria-hidden":"true",children:" *"})]});return c==="legend"?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"nhsuk-fieldset__legend nhsuk-fieldset__legend--m",id:r,children:e.jsx("span",{className:"nhsuk-fieldset__heading",children:g})}),u,i,d]}):c==="label"?e.jsxs(e.Fragment,{children:[e.jsx("label",{className:"nhsuk-fieldset__legend nhsuk-fieldset__legend--s",id:r,htmlFor:a,children:e.jsx("span",{className:"nhsuk-fieldset__heading",children:g})}),u,i,d]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"nhsuk-label",id:r,children:g}),u,i,d]})}function Bn({children:n}){return e.jsxs("span",{className:"nhsuk-label__prefix",children:[n," "]})}Te.__docgenInfo={description:"",methods:[],displayName:"Label",props:{as:{defaultValue:{value:'"label"',computed:!1},required:!1}}};function Se({linkId:n,header:t,children:s,errors:r}){const a=r?"nhsuk-form-group nhsuk-form-group--error":"nhsuk-form-group";return e.jsxs("div",{className:a,"data-linkid":n,children:[t,r,s]})}Se.__docgenInfo={description:"",methods:[],displayName:"QuestionScaffold"};function Ee({isLoading:n}){if(n)return e.jsx("div",{className:"nhsuk-hint",role:"status",children:"Loading options…"})}Ee.__docgenInfo={description:"",methods:[],displayName:"OptionsLoading"};function Me({id:n,children:t,ariaLabel:s}){return e.jsx("div",{className:"nhsuk-hint",id:n,"aria-label":s,children:t})}Me.__docgenInfo={description:"",methods:[],displayName:"Help"};function ze({id:n,children:t,ariaLabel:s}){return e.jsx("div",{className:"nhsuk-hint",id:n,"aria-label":s,children:t})}ze.__docgenInfo={description:"",methods:[],displayName:"Legal"};function Fe({id:n,children:t,ariaLabel:s}){return e.jsx("div",{className:"nhsuk-hint",id:n,"aria-label":s,children:t})}Fe.__docgenInfo={description:"",methods:[],displayName:"Flyover"};function De({linkId:n,children:t}){return e.jsx("div",{className:"nhsuk-card nhsuk-u-margin-bottom-0","data-linkId":n,children:e.jsx("div",{className:"nhsuk-card__content",children:t})})}De.__docgenInfo={description:"",methods:[],displayName:"Header"};function Ae({linkId:n,children:t}){return e.jsx("footer",{className:"nhsuk-footer",role:"contentinfo","data-linkid":n,children:e.jsx("div",{className:"nhsuk-width-container",children:t})})}Ae.__docgenInfo={description:"",methods:[],displayName:"Footer"};function Pe({children:n,onAdd:t,canAdd:s,addLabel:r}){const a=r??"Add";return e.jsxs(Hn,{children:[n,t&&e.jsx("div",{className:"nhsuk-button-group",children:e.jsx("button",{type:"button",onClick:t,disabled:s===!1,className:"nhsuk-button nhsuk-button--secondary nhsuk-button--small",children:a})})]})}const Hn=b.div`
  display: flex;
  flex-direction: column;
  gap: var(--nhsuk-spacing-2);
`;Pe.__docgenInfo={description:"",methods:[],displayName:"AnswerList"};function Ve({control:n,onRemove:t,canRemove:s,errors:r,children:a}){return e.jsxs(Ln,{children:[e.jsxs(Kn,{children:[e.jsxs(qn,{children:[n,r]}),t&&e.jsx(Yn,{children:e.jsx("div",{className:"nhsuk-button-group",children:e.jsx("button",{type:"button",onClick:t,disabled:s===!1,className:"nhsuk-button nhsuk-button--secondary nhsuk-button--small",children:"Remove"})})})]}),e.jsx(Gn,{children:a})]})}const Ln=b.div`
  display: flex;
  flex-direction: column;
...
`;Ve.__docgenInfo={description:"",methods:[],displayName:"AnswerScaffold"};function Be({onSubmit:n,onCancel:t,children:s,title:r,description:a,errors:o,before:u,after:i,pagination:d}){const c=m=>{m.preventDefault(),n?.()},p=t??(()=>{}),x=e.jsxs(e.Fragment,{children:[e.jsx(ce,{variant:"primary",type:"submit",disabled:!n,children:"Submit"}),e.jsx(ce,{variant:"secondary",type:"button",onClick:p,disabled:!t,children:"Cancel"})]}),g=r||a?e.jsxs("header",{className:"nhsuk-u-margin-bottom-4",children:[!!r&&e.jsx("h1",{className:"nhsuk-heading-l nhsuk-u-margin-bottom-1",children:r}),!!a&&e.jsx("span",{className:"nhsuk-caption-l",children:a})]}):void 0;if(d){const m=Un(d.current,d.total),w=v=>{if(v===d.current)return;const j=Math.abs(v-d.current),k=v<d.current?d.onPrev:d.onNext;for(let _=0;_<j;_+=1)k()};return e.jsxs("form",{onSubmit:c,children:[g&&e.jsx(Zn,{children:g}),!!o&&e.jsx(se,{children:o}),!!u&&e.jsx(se,{children:u}),s,e.jsxs("nav",{className:"nhsuk-pagination nhsuk-pagination--numbered",role:"navigation","aria-label":"Pagination",children:[d.disabledPrev?void 0:e.jsxs("a",{href:"#",className:"nhsuk-pagination__previous",rel:"prev",onClick:v=>{v.preventDefault(),d.onPrev()},children:[e.jsx(Wn,{}),e.jsxs("span",{className:"nhsuk-pagination__title",children:["Previous",e.jsx("span",{className:"nhsuk-u-visually-hidden",children:" page"})]})]}),e.jsx("ul",{className:"nhsuk-pagination__list",children:m.map((v,j)=>{if(v.type==="ellipsis")return e.jsx("li",{className:"nhsuk-pagination__item nhsuk-pagination__item--ellipsis",children:"⋯"},`ellipsis-${j}`);const k=v.current?"nhsuk-pagination__item nhsuk-pagination__item--current":"nhsuk-pagination__item";return e.jsx("li",{className:k,children:e.jsx("a",{className:"nhsuk-pagination__link",href:"#","aria-label":`Page ${v.page}`,"aria-current":v.current?"page":void 0,onClick:_=>{_.preventDefault(),w(v.page)},children:v.page})},v.page)})}),d.disabledNext?void 0:e.jsxs("a",{href:"#",className:"nhsuk-pagination__next",rel:"next",onClick:v=>{v.preventDefault(),d.onNext()},children:[e.jsxs("span",{className:"nhsuk-pagination__title",children:["Next",e.jsx("span",{className:"nhsuk-u-visually-hidden",children:" page"})]}),e.jsx(Qn,{})]})]}),e.jsx("div",{className:"nhsuk-button-group",children:x}),!!i&&e.jsx(se,{children:i})]})}return e.jsxs("form",{onSubmit:c,children:[g,o,u,s,i,e.jsx("div",{className:"nhsuk-button-group",children:x})]})}function Un(n,t){const s=new Set([1,t]);for(const o of[-2,-1,0,1,2]){const u=n+o;u>=1&&u<=t&&s.add(u)}const r=[...s].toSorted((o,u)=>o-u),a=[];return r.forEach((o,u)=>{const i=r[u-1];i!=null&&o-i>1&&a.push({type:"ellipsis"}),a.push({type:"page",page:o,current:o===n})}),a}function Wn(){return e.jsx("svg",{className:"nhsuk-icon nhsuk-icon--arrow-left",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",width:"16",height:"16",focusable:"false","aria-hidden":"true",children:e.jsx("path",{d:"M10.7 6.3c.4.4.4 1 0 1.4L7.4 11H19a1 1 0 0 1 0 2H7.4l3.3 3.3c.4.4.4 1 0 1.4a1 1 0 0 1-1.4 0l-5-5A1 1 0 0 1 4 12c0-.3.1-.5.3-.7l5-5a1 1 0 0 1 1.4 0Z"})})}function Qn(){return e.jsx("svg",{className:"nhsuk-icon nhsuk-icon--arrow-right",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",width:"16",height:"16",focusable:"false","aria-hidden":"true",children:e.jsx("path",{d:"m14.7 6.3 5 5c.2.2.3.4.3.7 0 .3-.1.5-.3.7l-5 5a1 1 0 0 1-1.4-1.4l3.3-3.3H5a1 1 0 0 1 0-2h11.6l-3.3-3.3a1 1 0 1 1 1.4-1.4Z"})})}function ce({variant:n,type:t="button",onClick:s,disabled:r,children:a}){const o=n==="primary"?"nhsuk-button":"nhsuk-button nhsuk-button--secondary";return e.jsx("button",{type:t,onClick:s,disabled:r,className:o,children:a})}const Zn=b.div`
  display: flex;
  flex-direction: column;
  gap: calc(var(--nhsuk-spacing-1) + var(--nhsuk-spacing-2));
`,se=b.div`
...
`;qe.__docgenInfo={description:"",methods:[],displayName:"Table"};function Ye({children:n,spans:t}){const s=y.Children.toArray(n);return e.jsx(nt,{children:s.map((r,a)=>e.jsx(tt,{$span:t[a],children:r},a))})}const nt=b.div`
  display: flex;
  width: 100%;
...
`,tt=b.div`
  flex: ${n=>`${n.$span} 1 0`};
  min-width: 0;
`;Ye.__docgenInfo={description:"",methods:[],displayName:"InputGroup"};function Ge({id:n,ariaLabelledBy:t,ariaDescribedBy:s,disabled:r,accept:a,value:o,onChange:u}){const i=o!=null,d=o?.title??o?.url??(i?"Attachment selected":""),c=o?.size==null?"":`${Math.round(o.size/1024)} KB`,p=i?`${d}${c?` (${c})`:""}`:"",x=K(s)?"nhsuk-input nhsuk-input--error":"nhsuk-input",g=y.useRef(null),m=()=>{r||g.current?.click()},w=j=>{const k=j.currentTarget.files?.[0];if(k!==void 0)try{u?.(k)}finally{j.currentTarget.value=""}},v=j=>{r||(j.key==="Enter"||j.key===" ")&&(j.preventDefault(),m())};return e.jsxs("div",{className:"nhsuk-input-wrapper nhsuk-u-width-full",children:[e.jsx(at,{className:x,type:"text",value:p,placeholder:"No file chosen",readOnly:!0,disabled:r,"aria-labelledby":t,"aria-describedby":s,onClick:m,onKeyDown:v}),e.jsx(st,{ref:g,id:n,"aria-labelledby":t,"aria-describedby":s,className:"nhsuk-file-upload",disabled:r,type:"file",onChange:w,accept:a}),e.jsx("button",{className:"nhsuk-button nhsuk-button--secondary nhsuk-button--small",type:"button",onClick:m,disabled:r,children:i?"Change file":"Choose file"}),i&&e.jsx("button",{className:"nhsuk-button nhsuk-button--secondary nhsuk-button--small",type:"button",onClick:()=>u?.(),disabled:r,"aria-label":"Clear attachment",children:"Clear"})]})}const st=b.input`
  display: none;
`,at=b.input`
  flex: 1;
